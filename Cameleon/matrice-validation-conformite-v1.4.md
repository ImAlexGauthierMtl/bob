...
| CI-06 | Couverture 85 %, JUnit, Cobertura | § 4.9 | `dx_base_check_cicd_coverage_85_percent` | Lire jobs test | VIOLATION | Pilote `kb-b4f-api` packagé avec tests et seuil 85 % validé localement + commande template; les autres APIs CDE restent à packager et sont encore skippées |
