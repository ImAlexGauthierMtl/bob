...
| CI-06 | Couverture 85 %, JUnit, Cobertura | § 4.9 | `dx_base_check_cicd_coverage_85_percent` | Lire jobs test | VIOLATION | `auth-b4f-api`, `crm-b4f-api`, `kb-b4f-api` et `platform-b4f-api` packagés avec tests et seuil 85 % validés localement + commande template; les autres APIs CDE restent à packager et sont encore skippées |
