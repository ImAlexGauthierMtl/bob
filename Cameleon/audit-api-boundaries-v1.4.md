...
|---|---|---|
| `auth-b4f-api` | Auth/session/admin IAM | Conforme au domaine frontend; le flux JWT, refresh, rate limit et session courante passe par `AuthUseCases`. Les routes admin user/tenant/role restent surtout des facades CRUD. |
