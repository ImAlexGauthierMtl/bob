...
router = APIRouter(prefix="/api/v1/provider/membrane")
...
async def get_connect_url(
    ...
    # The /connect-redirect endpoint stays publicly reachable through the B4F route.
    # PUBLIC_API_URL points to the public API as seen from the browser.
    # Falls back to INGRESS_URL if not set.
