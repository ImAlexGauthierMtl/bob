"""KB Backend API — CRUD + persistence for kb entities.
...
async def lifespan(app: FastAPI):
    ...
    logger.info("kb_backend_api_started", port=settings.api_port)
    yield
    logger.info("kb_backend_api_shutdown")


app = FastAPI(
    title="KB Backend API",
    description="KB — CRUD + Persistence — Croo Digital Experience",
    version="1.0.0",
    lifespan=lifespan,
)
