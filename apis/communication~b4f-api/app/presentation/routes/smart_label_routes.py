"""Smart Label routes — CRUD for AI email tags."""
...
async def create_smart_label(
    ...
    # Check if a label with the same name already exists for this tenant under that parent
...
async def update_smart_label(
    ...
    if "name" in update_data:
        # Avoid duplicate names if changed within the same parent
