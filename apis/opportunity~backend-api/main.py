"""Opportunity Backend API — CRUD + persistence for opportunity entities.
...
async def lifespan(app: FastAPI):
    ...
    logger.info("opportunity_backend_api_started", port=settings.api_port)
    yield
    logger.info("opportunity_backend_api_shutdown")


app = FastAPI(
    title="Opportunity Backend API",
    description="Opportunity — CRUD + Persistence — Croo Digital Experience",
    version="1.0.0",
    lifespan=lifespan,
)
