"""Contact Backend API — CRUD + persistence for contact entities.
...
async def lifespan(app: FastAPI):
    ...
    logger.info("contact_backend_api_started", port=settings.api_port)
    yield
    logger.info("contact_backend_api_shutdown")


app = FastAPI(
    title="Contact Backend API",
    description="Contact — CRUD + Persistence — Croo Digital Experience",
    version="1.0.0",
    lifespan=lifespan,
)
