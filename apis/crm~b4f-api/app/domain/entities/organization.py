...
class OrganizationStatus(str, enum.Enum):
    ACTIVE = "ACTIVE"; INACTIVE = "INACTIVE"; PROSPECT = "PROSPECT"; CUSTOMER = "CUSTOMER"; CHURNED = "CHURNED"

class OrganizationType(str, enum.Enum):
    CORPORATION = "CORPORATION"; SMB = "SMB"; STARTUP = "STARTUP"; GOVERNMENT = "GOVERNMENT"; NONPROFIT = "NONPROFIT"; OTHER = "OTHER"
...
class Organization(Base, TenantMixin, AuditMixin, SoftDeleteMixin):
    ...
    linked_activities = relationship("Activity", secondary=activity_organizations, back_populates="organizations", lazy="selectin")
