"""Product entity."""
import enum
from sqlalchemy import Column, String, Text, Enum as SAEnum, Numeric, Boolean, Integer, ForeignKey
from sqlalchemy.orm import relationship
from app.domain.entities.base import Base, TenantMixin, AuditMixin, SoftDeleteMixin, generate_uuid

class ProductCategory(str, enum.Enum):
    SOFTWARE = "SOFTWARE"; SERVICE = "SERVICE"; ADD_ON = "ADD_ON"; CONSULTING = "CONSULTING"; HARDWARE = "HARDWARE"

class BillingCycle(str, enum.Enum):
    MONTHLY = "MONTHLY"; QUARTERLY = "QUARTERLY"; SEMI_ANNUAL = "SEMI_ANNUAL"; ANNUAL = "ANNUAL"

class LicenseType(str, enum.Enum):
    PERPETUAL = "PERPETUAL"; SUBSCRIPTION = "SUBSCRIPTION"; USAGE_BASED = "USAGE_BASED"

class BillingUnit(str, enum.Enum):
    HOUR = "HOUR"; DAY = "DAY"; PROJECT = "PROJECT"; RETAINER = "RETAINER"
...
class Product(Base, TenantMixin, AuditMixin, SoftDeleteMixin):
    ...
    parent_product_id = Column(String(36), ForeignKey("products.id"), nullable=True, index=True)
    is_coterminus = Column(Boolean, nullable=True, default=True)
    parent_product = relationship("Product", remote_side=[id], backref="addons")
