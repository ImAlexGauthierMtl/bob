"""Department entity — organizational unit for capability grouping."""
...
class Department(Base, TenantMixin, AuditMixin, SoftDeleteMixin):
    ...
    Users belong to departments via M:N (UserDepartment).
    Departments have default capabilities (DeptCapability).
    """
...
class UserDepartment(Base):
    """M:N join table — User ↔ Department."""
